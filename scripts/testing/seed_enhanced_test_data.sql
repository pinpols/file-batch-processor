...
INSERT INTO task_execution_state (task_id, batch_date, rerun_id, tenant_id, biz_domain, status, attempt, max_attempts, next_retry_at, window_start, window_end, last_error, error_code, created_at, updated_at) VALUES
    ('fileImportJob', '2026-03-01', '', 'tenant-001', 'finance', 'COMPLETED', 1, 3, NULL, '2026-03-01 09:00:00', '2026-03-01 18:00:00', NULL, NULL, '2026-03-01 09:00:00', '2026-03-01 10:30:00'),
...
INSERT INTO batch_run_records (job_name, batch_date, run_id, status, total_records, success_records, failed_records, start_time, end_time, created_at, updated_at) VALUES
    ('fileImportJob', '2026-03-01', 'run-001', 'COMPLETED', 1000, 995, 5, '2026-03-01 09:00:00', '2026-03-01 10:30:00', '2026-03-01 09:00:00', '2026-03-01 10:30:00'),
...
INSERT INTO record_trace (trace_id, task_id, batch_date, run_id, business_key, operation, status, start_time, end_time, created_at, updated_at) VALUES
    ('trace-001', 'fileImportJob', '2026-03-01', 'run-001', 'FIN001', 'IMPORT', 'SUCCESS', '2026-03-01 09:05:00', '2026-03-01 09:05:30', '2026-03-01 09:05:00', '2026-03-01 09:05:30'),
    ('trace-002', 'fileImportJob', '2026-03-01', 'run-001', 'FIN002', 'IMPORT', 'SUCCESS', '2026-03-01 09:10:00', '2026-03-01 09:10:25', '2026-03-01 09:10:00', '2026-03-01 09:10:25'),
...
INSERT INTO quality_gate_results (task_id, batch_date, run_id, gate_type, threshold_value, actual_value, status, error_message, created_at, updated_at) VALUES
    ('fileImportJob', '2026-03-01', 'run-001', 'PARSE_ERROR_RATE', 5.0, 0.5, 'PASSED', NULL, '2026-03-01 10:30:00', '2026-03-01 10:30:00'),
...
INSERT INTO task_definition (task_id, job_name, description, tenant_id, biz_domain, priority, enabled, created_at, updated_at) VALUES
    ('fileImportJob', 'fileImportJob', '文件处理作业', 'tenant-001', 'finance', 'NORMAL', true, '2026-03-01 08:00:00', '2026-03-01 08:00:00'),
...
INSERT INTO task_trigger (task_id, trigger_type, cron_expression, fixed_rate_ms, fixed_delay_ms, one_time_at, enabled, created_at, updated_at) VALUES
    ('fileImportJob', 'CRON', '0 30 9 * * ?', NULL, NULL, NULL, true, '2026-03-01 08:00:00', '2026-03-01 08:00:00'),
