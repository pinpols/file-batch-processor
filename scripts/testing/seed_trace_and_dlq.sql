...
values
  ('Alice:2026-03-01', '2026-03-01', 'importJob', 1, 'IMPORT', 'SUCCESS', null, now()),
...
values
  ('importJob', 'businessKey=Alice:2026-03-01&name=Alice&description=dlq&batchDate=2026-03-01&source=record-writer', 'synthetic', false, now());
