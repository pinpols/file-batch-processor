...
class CalendarExclusionServiceIntegrationTest {
    ...
    void shouldExcludeWeekends() {
        // Given
        java.time.Instant friday = java.time.Instant.parse("2026-03-07T10:00:00Z");
        java.time.Instant saturday = java.time.Instant.parse("2026-03-08T10:00:00Z");
        java.time.Instant monday = java.time.Instant.parse("2026-03-09T10:00:00Z");

        // When & Then
        assertTrue(calendarExclusionService.isExcluded(friday, "default"), "Friday should not be excluded");
        assertTrue(calendarExclusionService.isExcluded(saturday, "default"), "Saturday should be excluded");
        assertTrue(calendarExclusionService.isExcluded(monday, "default"), "Monday should not be excluded");
    }
    ...
    void shouldExcludeTimeWindows() {
        // Given
        java.time.Instant nightTime = java.time.Instant.parse("2026-03-07T23:00:00Z");
        java.time.Instant lunchTime = java.time.Instant.parse("2026-03-07T12:30:00Z");
        java.time.Instant workTime = java.time.Instant.parse("2026-03-07T14:00:00Z");
    ...
    void shouldGetNextAvailableTime() {
        // Given
        java.time.Instant fridayNight = java.time.Instant.parse("2026-03-07T23:00:00Z");

        // When
        java.time.Instant nextAvailable = calendarExclusionService.getNextAvailableTime(fridayNight, "default");

        // Then - should skip to Monday morning
        java.time.Instant expected = java.time.Instant.parse("2026-03-08T09:00:00Z");
