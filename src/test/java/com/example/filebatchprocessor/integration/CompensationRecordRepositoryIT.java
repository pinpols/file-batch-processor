...
class CompensationRecordRepositoryIT extends PostgresContainerSupport {
    ...
    void shouldFindByLegacyDistributionTaskId() {
        com.example.filebatchprocessor.model.FileDistributionTask task =
                new com.example.filebatchprocessor.model.FileDistributionTask();
        ...
        List<CompensationRecord> result =
                repository.findByLegacyDistributionTaskIdOrderByCreatedAtDesc(savedTask.getId());
