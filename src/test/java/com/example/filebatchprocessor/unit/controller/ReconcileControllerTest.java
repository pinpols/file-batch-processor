...
import com.example.filebatchprocessor.controller.ReconcileController;
...
class ReconcileControllerTest {
    ...
    private final ReconcileRunRecordRepository reconcileRunRecordRepository =
            org.mockito.Mockito.mock(ReconcileRunRecordRepository.class);
    private final ReconcileDiffRecordRepository reconcileDiffRecordRepository =
            org.mockito.Mockito.mock(ReconcileDiffRecordRepository.class);
    ...
    void shouldReturnRuns() throws Exception {
        ...
        org.mockito.Mockito.when(reconcileRunRecordRepository.findTop50ByOrderByCreatedAtDesc())
                .thenReturn(List.of(run));

        ReconcileController controller =
                new ReconcileController(reconcileRunRecordRepository, reconcileDiffRecordRepository);
    ...
    void shouldReturnDiffs() throws Exception {
        ...
        org.mockito.Mockito.when(reconcileDiffRecordRepository.findTop200ByReconcileRunIdOrderByIdAsc(1L))
