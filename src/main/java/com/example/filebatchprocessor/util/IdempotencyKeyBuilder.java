...
public final class IdempotencyKeyBuilder {
    ...
    public static String forImportRequest(String inputFile, String batchDate, String rerunId, int shardIndex, int shardTotal) {
        return String.join("|",
                "processFileJob",
                safe(inputFile),
                safe(batchDate),
