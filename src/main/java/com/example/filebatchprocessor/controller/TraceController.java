...
public class TraceController {
    ...
    public Map<String, Object> trace(@PathVariable String businessKey) {
        ...
        List<ImportedRecordPartitioned> imported =
                importedRecordPartitionedRepository.findTop50ByBusinessKeyOrderByCreatedAtDesc(businessKey);
        List<DlqRecord> dlq =
                dlqRecordRepository.findTop50ByParamsContainingOrderByCreatedAtDesc("businessKey=" + businessKey);
        List<JobLogRecord> jobLogs =
                jobLogRecordRepository.findTop50ByParamsContainingOrderByCreatedAtDesc(businessKey);
