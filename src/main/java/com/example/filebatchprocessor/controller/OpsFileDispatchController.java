...
public class OpsFileDispatchController {
    ...
    public OpsFileDispatchController(
            FileDistributionService fileDistributionService, FileDispatchRecordService fileDispatchRecordService) {
    ...
    public Map<String, Object> acknowledge(
        ...
        fileDistributionService.acknowledgeDispatch(
                taskId, ackRequest.accepted(), operatorName, ackRequest.message(), ackRequest.payload(), null);
    ...
    public Map<String, Object> resend(
        ...
        String operatorName = authentication == null ? "SYSTEM" : authentication.getName();
        fileDistributionService.scheduleResend(
                taskId,
                operatorName,
    ...
    private Map<String, Object> dispatchResponse(Long taskId, String operatorName) {
        ...
        FileDispatchRecord dispatchRecord =
                fileDispatchRecordService.findByLegacyDistributionTaskId(taskId).orElse(null);
