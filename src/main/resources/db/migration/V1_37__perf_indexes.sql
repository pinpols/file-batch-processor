...
-- #17 task_execution_state 最热查询 findByTaskIdAndBatchDateAndRerunId 此前只能走单列 task_id 索引,
...
-- #29 澄清:imported_records_partition 命名带 partition 但实为普通堆表,不存在真正的分区裁剪。
